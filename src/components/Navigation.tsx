...
export const navigation: Array<NavGroup> = [
  ...
  },
  {
    ...
    links: [
      ...
      {
        title: '5 Compelling Reasons to Utilize Arthur Labs',
        href: '/blogs/5-compelling-reasons-to-utilize-arthur-labs-blockchain-infrastructure-for-your-business',
      },
      {
        title: '5 Upcoming Trends in Blockchain & Web3 That Will Shape 2025',
        href: '/blogs/blog-1748898754894',
      },
      {
        title: 'A Guide to Optimizing Next.js Applications',
        href: '/blogs/a-guide-to-optimizing-nextjs-applications',
      },
      ...
      {
        title: 'From Proof-of-Concept to Production: Scaling AI Solutions',
        href: '/blogs/from-proof-of-concept-to-production-scaling-ai-solutions',
      },
      ...
      {
        title: 'The Evolution of AI: From Rule-Based Systems to Deep Learnin',
        href: '/blogs/the-evolution-of-ai-from-rule-based-systems-to-deep-learning',
      },
