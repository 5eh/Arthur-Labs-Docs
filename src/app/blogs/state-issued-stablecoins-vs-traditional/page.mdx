...
export const metadata = {
  alternates: { canonical: '/blogs/state-issued-stablecoins-vs-traditional/' },
  title: 'State-Issued Stablecoins vs USDC USDT: The Regulatory Divide',
  description:
...
<div className="not-prose mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
  ...
  <div className="flex gap-4">
    ...
    <Button href="https://builder.arthurlabs.net/contact" variant="outline">Contact Us</Button>
  </div>
</div>
