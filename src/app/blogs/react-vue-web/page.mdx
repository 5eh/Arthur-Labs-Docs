...
export const metadata = {
  alternates: { canonical: '/blogs/react-vue-web/' },
...
<h1> React vs. Vue: The Ultimate Web Development Comparison Guide </h1>
...
<h2 id="core-philosophy-learning-curve">Core Philosophy and Learning Curve </h2>
...
<h2 id="state-management-community-support"> Performance and Ecosystem </h2>
...
<h2 id="state-management-community-support"> State Management, Tooling, and Community Support </h2>
