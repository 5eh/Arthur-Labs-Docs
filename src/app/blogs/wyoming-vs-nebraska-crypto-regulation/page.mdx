...
export const metadata = {
  alternates: { canonical: '/blogs/wyoming-vs-nebraska-crypto-regulation/' },
  title: 'Wyoming vs Nebraska: Crypto Regulation Comparison 2026',
  description:
...
<div className="not-prose mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
  ...
  <div className="flex gap-4">
    <Button href="https://builder.arthurlabs.net/contact">Contact Us</Button>
