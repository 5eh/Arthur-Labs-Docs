...
export const metadata = {
  alternates: { canonical: '/blogs/wyoming-wyst-fundora-stablecoin-opportunities/' },
  title: 'Wyoming Stabletoken WYST: The New Stablecoin Economy',
  description:
...
<div className="not-prose mt-6 mb-16 flex gap-3">
  ...
  <Button href="https://builder.arthurlabs.net/contact">Get Help</Button>
</div>
