...
export const metadata = {
  alternates: { canonical: '/blogs/wyoming-ai-agents-autonomous-business/' },
  title: 'Wyoming AI Agents: The Dawn of Autonomous Business Entities',
  description:
...
<div className="not-prose mt-12 pt-8 border-t border-gray-200 dark:border-gray-700">
  ...
  <div className="flex gap-4">
    ...
    <Button href="https://builder.arthurlabs.net/contact" variant="outline">Get in Touch</Button>
  </div>
</div>
