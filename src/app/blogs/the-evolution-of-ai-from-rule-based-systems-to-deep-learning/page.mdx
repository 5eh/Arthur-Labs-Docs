...
export const metadata = {
  alternates: { canonical: '/blogs/the-evolution-of-ai-from-rule-based-systems-to-deep-learning/' },
  title: 'The Evolution of AI: From Rule-Based Systems to Deep Learning',
