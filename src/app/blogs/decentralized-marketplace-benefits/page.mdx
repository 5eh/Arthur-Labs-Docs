...
export const metadata = {
  alternates: { canonical: '/blogs/decentralized-marketplace-benefits/' },
  title: '5 Compelling Reasons to Utilize Decentralized Marketplace Platforms for Your Business',
...
<div className="my-8 p-6 bg-blue-50 dark:bg-slate-800 rounded-lg">
  ...
  <Button href="https://arthurlabs.net/contact">Learn More</Button>
</div>
