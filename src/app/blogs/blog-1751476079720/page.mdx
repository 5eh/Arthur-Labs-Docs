...
### 1. The NFT Contract (ERC-721)

This contract needs to be more than a standard ERC-721. It must include a state machine and permissions for the oracle.
...
contract RealWorldAssetNFT is ERC721 {
    // ... constructor, etc.

    enum Status { Unverified, AwaitingVerification, Verified, Shipped, Delivered }

    struct Asset {
        Status status;
        string physicalAssetID; // e.g., serial number
    }
